...
readonly PRINTER_IP='192.168.0.77'
readonly PRINTER_NAME='ApeosPortC3070'
readonly PRINTER_DISPLAY_NAME='ApeosPort C3070'
readonly PRINTER_LOCATION='Maple Office'
...
CheckIcon() {
	...
	/usr/bin/curl -skL -k "$PRINTER_ICON" -o "$ICON"
